...
class SparsePointPillarsSparse1Dense23(SparsePointPillars):
    ...
    def __init__(self,
                 name="SparsePointPillarsSparse1Dense23",
                 device="cuda",
        ...
        super().__init__(name=name,
                         ...
                         loss=loss,
                         **kwargs)
        self.backbone = SparseSECONDSparse1Dense23(**backbone)
        self.neck = SparseSECONDFPNSparse1Dense23(**neck)
...
MODEL._register_module(SparsePointPillarsSparse1Dense23, 'torch')


class SparseSECONDSparse1Dense23(SparseSECOND):
    ...
    def __init__(self,
                 ...
                 layer_nums=[3, 5, 5],
                 layer_strides=[2, 2, 2]):
        super(SparseSECONDSparse1Dense23, self).__init__()
    ...
    def forward(self, x):
        ...
        for i in range(len(self.blocks)):
            if i == 1:
                dense_shape = torch.Size([input_shape[0], input_shape[3], input_shape[1] // 2, input_shape[2] // 2])
...
class SparseSECONDFPNSparse1Dense23(nn.Module):
    ...
    def __init__(self,
        ...
        super(SparseSECONDFPNSparse1Dense23, self).__init__()
